...
{{
  ...
  "category": "本則知識的角度分類（從以下選一）：外觀辨別｜食用知識｜生態習性｜台灣特色｜處理與保存｜料理法｜選購技巧｜常見誤解｜名稱由來｜相似魚種比較｜產季與時機｜冷知識趣聞｜漁法介紹｜捕魚時機｜漁港文化｜漁民智慧｜船種介紹｜漁具設備｜出海作業｜飲食文化｜冷凍原理｜破除迷思",
...
龜吼實際使用的漁法（優先）：棒受網、刺網、一支釣、延繩釣、拖網、蟹籠、手釣、潛水採集
其他漁法：定置網、圍網、流刺網、魚叉、曳繩釣、夜間集魚燈釣法
漁港：龜吼漁港（主場）、野柳漁港、富基漁港、基隆正濱漁港、澳底漁港、南方澳漁港

【漁船知識】角度（4）：船種介紹｜漁具設備｜出海作業｜飲食文化
船種：膠筏、小漁船、延繩釣船、拖網船、圍網船、娛樂漁船
設備：集魚燈、聲納魚探機、GPS定位、冰艙保鮮、漁網材質、無線電通訊
生活：出海時間週期、船上分工、惡劣天氣應對、討海人飲食、漁村文化與信仰

【冷鏈知識】角度（2，目前只開這兩個）：冷凍原理｜破除迷思
主題：急速冷凍與慢速冷凍的差別、最大冰晶生成帶、解凍滴液、冰衣（glazing）、
凍燒、真空包裝在防什麼、魚油氧化與酸敗、脂肪含量與風味期限、
冷鏈有幾個環節、家用冰箱與商用冷凍庫的差別、清洗用水的滲透壓

🔴 【冷鏈知識】的硬性限制（涉及食品安全，違反等於發出錯誤的食安資訊）：
  1. **只准使用這兩個已查證的數字**：冷凍保存 −18°C 以下；最大冰晶生成帶 −1～−5°C。
     **其他任何溫度、天數、月數、小時數一律不准出現**——包括「可以放三個月」
     「解凍兩小時」這種。不確定就講原理，不要給數字。
