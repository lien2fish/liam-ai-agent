...
JOBS = [
    (
        "六邊形牌_理事長[已移除]_邊長19cm_CMYK.tiff",
        "理事長",
        "[已移除]",
        "六邊形牌_理事長[已移除]_邊長19cm_向量",
    ),
    (
        "六邊形牌_名譽理事長[已移除]_邊長11cm_CMYK.tiff",
        "名譽理事長",
        "[已移除]",
        "六邊形牌_名譽理事長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_副理事長[已移除]_邊長11cm_CMYK.tiff",
        "副理事長",
        "[已移除]",
        "六邊形牌_副理事長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_副理事長[已移除]_邊長11cm_CMYK.tiff",
        "副理事長",
    ...
    (
        "六邊形牌_副秘書長[已移除]_邊長11cm_CMYK.tiff",
        "副秘書長",
        "[已移除]",
        "六邊形牌_副秘書長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_秘書長[已移除]_邊長11cm_CMYK.tiff",
        "秘書長",
        "[已移除]",
        "六邊形牌_秘書長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_財務長[已移除]_邊長11cm_CMYK.tiff",
        "財務長",
        "[已移除]",
        "六邊形牌_財務長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_事務長[已移除]_邊長11cm_CMYK.tiff",
        "事務長",
        "[已移除]",
        "六邊形牌_事務長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_公關長[已移除]_邊長11cm_CMYK.tiff",
        "公關長",
        "[已移除]",
        "六邊形牌_公關長[已移除]_邊長11cm_向量",
    ),
    (
        "六邊形牌_常務監事[已移除]_邊長8.5cm_雙板.tiff",
        "常務監事",
        "[已移除]",
        "六邊形牌_常務監事[已移除]_邊長8.5cm_向量",
    ),
    (
        "六邊形牌_常務理事[已移除]_邊長8.5cm_雙板.tiff",
        "常務理事",
        "[已移除]",
        "六邊形牌_常務理事[已移除]_邊長8.5cm_向量",
    ),
    (
        "六邊形牌_常務理事[已移除]_邊長8.5cm_雙板.tiff",
        "常務理事",
    ...
    (
        "六邊形牌_監事[已移除]_邊長8.5cm_CMYK.tiff",
        "監事",
        "[已移除]",
        "六邊形牌_監事[已移除]_邊長8.5cm_向量",
    ),
    (
        "六邊形牌_理事[已移除]_邊長8.5cm_CMYK.tiff",
        "理事",
        "[已移除]",
        "六邊形牌_理事[已移除]_邊長8.5cm_向量",
    ),
    (
        "六邊形牌_理事[已移除]_邊長8.5cm_CMYK.tiff",
        "理事",
    ...
    # 理事[已移除] 2026-07-22 卸任，由[已移除]接替；原檔移至 已撤除_20260722/
    (
        "六邊形牌_理事[已移除]_邊長8.5cm_CMYK.tiff",
        "理事",
        "[已移除]",
    ...
    (
        "六邊形牌_榮譽顧問[已移除]_邊長8.5cm_雙板.tiff",
        "榮譽顧問",
        "[已移除]",
        "六邊形牌_榮譽顧問[已移除]_邊長8.5cm_向量",
    ),
    (
        "六邊形牌_榮譽顧問[已移除]_邊長8.5cm_雙板.tiff",
        "榮譽顧問",
