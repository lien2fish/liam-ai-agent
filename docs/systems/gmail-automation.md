...
| 產出 | 去向 | 進版控？ |
|------|------|---------|
| 清理報告 | Email，本機留 `reports/gmail_cleanup_YYYY-MM.md` | ❌ gitignore |
| 新聞摘要 | `今日新聞摘要.md` ＋ `day/新聞日報_*.pdf` | ✅ |

🔴 清理報告不進公開 repo：表格裡某銀行清了 N 封，N>0 就等於證實這信箱是該行客戶。
（2026-09-03 改，與回購提醒／壽險拜訪／生日提醒一致。）
